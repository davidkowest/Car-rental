...
public class StatisticsCalculatorTest {
    ...
    public void testUtilizationForShortPeriod() throws Exception {
        ...
        //act
        Map<String, Float> result = statisticsCalculator.calculateTotalUtilizationPerClass(rentalClasses, rentedCarHistories, startDate, endDate);
        //assert
    ...
    public void testEarningsForShortPeriod() throws Exception {
        ...
        List<RentedCarHistory> rentedCarHistories = getListOfHistoriesForShortPeriod();
        //act
        Map<String, Float> result = statisticsCalculator.calculateTotalEarningsPerClass(rentedCarHistories);
        //assert
        SoftAssert sa = new SoftAssert();
    ...
    public void testUtilizationPerDayForShortPeriod() {
        ...
        //act
        Table<String, DayOfWeek, Float> result = statisticsCalculator.calculateUtilizationPerClassAndDay(rentalClasses, rentedCarHistories, startDate, endDate);
        //assert
        SoftAssert sa = new SoftAssert();
