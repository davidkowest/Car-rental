...
public class RentedCarHistoryTableModel extends AbstractSwingTableModel<RentedCarHistoryDTO> {
    ...
    public RentedCarHistoryTableModel(){
        ...
        this.columnAndActionMap.put("Date of rent ", RentedCarHistoryDTO-> CustomFormatter.toShortFormat(RentedCarHistoryDTO.getDateOfRent()));
        this.columnAndActionMap.put("Date of return", RentedCarHistoryDTO->CustomFormatter.toShortFormat(RentedCarHistoryDTO.getDateOfReturn()));
